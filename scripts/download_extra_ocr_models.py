"""
下载日文 / 韩文 / 俄文 PP-OCRv3 识别 ONNX 及对应字符字典（rapidocr-onnxruntime 需要 dict 解码 CTC）。
...
SOURCES: list[tuple[str, str, str]] = [
    (
        ...
        "cycloneboy/japan_PP-OCRv3_rec_infer",
        "https://huggingface.co/breezedeus/cnocr-ppocr-japan_PP-OCRv3/resolve/main/japan_PP-OCRv3_rec_infer.onnx",
    ),
    (
    ...
    (
        ...
        "cycloneboy/cyrillic_PP-OCRv3_rec_infer",
...
DICT_SOURCES: list[tuple[str, str]] = [
    ("japan_dict.txt", "cycloneboy/japan_PP-OCRv3_rec_infer"),
    ("korean_dict.txt", "cycloneboy/korean_PP-OCRv3_rec_infer"),
    ("cyrillic_dict.txt", "cycloneboy/cyrillic_PP-OCRv3_rec_infer"),
]
